...
- (___VARIABLE_sceneName:identifier___View *)cView {
    return (___VARIABLE_sceneName:identifier___View *)self.view;
}

- (void)setCView:(___VARIABLE_sceneName:identifier___View *)cView {
    self.view = cView;
}

- (___VARIABLE_sceneName:identifier___View *)cViewIfLoaded {
    return (___VARIABLE_sceneName:identifier___View *)self.viewIfLoaded;
}
